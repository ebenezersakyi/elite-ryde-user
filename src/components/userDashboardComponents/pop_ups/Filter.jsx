...
const Filter = () => {
  ...
  return (
    <div className="text-[#fff] max-h-[100vh] overflow-y-scroll 2xl:container 2xl:mx-auto px-[2.5rem] my-[1.5rem] backdrop-blur-[12px] ">
      <div className="border-[1px] rounded-2xl  flex flex-col gap-[2rem] relative">
        <p
        ...
        <div className=" rounded-2xl border-bgrey p-8 divide-x-2 divide-bgrey  flex flex-wrap">
          <PriceSlide />
          <BodyStyleComponent />
          <DetailSelection />
        </div>
        <div className=" grid grid-cols-3 gap-[2rem] items-center">
          <div className=" border-[1px] grid grid-cols-3 col-span-3 items-center rounded-2xl border-bgrey divide-bgrey py-[3.5rem] divide-x-2 lg:col-span-2">
            <Picker
              img={location}
          ...
          <div
            ...
            className="rounded-2xl border-bgrey border-[1px] h-fit grid place-items-center text-[2rem] hover:bg-egreen/50 hover:border-egreen/50 cursor-pointer  px-[3rem] py-[1rem] col-span-3 lg:col-span-1"
          >
            Search
          </div>
        </div>
