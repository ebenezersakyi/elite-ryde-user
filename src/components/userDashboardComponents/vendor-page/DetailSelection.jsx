...
const DetailSelection = () => {
  const { engine_size, registration_year, color, number_of_seats } =
    useSelector((data) => data.details);
  ...
  return (
    ...
    >
      <Dropdown
        ...
        val={engine_size}
        setState={set_engine_size}
        param={"engine_size"}
      />
      <Dropdown
        category={"Registration year"}
        options={years}
        val={registration_year}
        setState={set_registration_year}
        param={"registration_year"}
      />
      <Dropdown
        category={"Seats"}
        options={seats}
        setState={set_number_of_seats}
        val={color}
