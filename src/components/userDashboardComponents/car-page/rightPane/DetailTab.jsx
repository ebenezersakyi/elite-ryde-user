...
const DetailTab = ({ icon, title, value }) => {
  return (
    <div
      className={`border-bgrey border-[1px] px-4 py-2 w-[280px] max-w-[100%] overflow-hidden m-[5px] flex relative items-center gap-[2rem]  text-[#fff] rounded-md`}
    >
      <span className="hidden sm:grid bg-[#ffffff] w-[3rem] h-[3rem] rounded-full place-items-center">
